...
### Peer Review
As a students of Code Instutute we have Slack as a resource to help and compliment our learning. We are able to post our web pages and GitHub repositories for other students to review. I would like to thank Matt Bodden for taking the time to look at my website and testing out the game. I'd like to thank Marina P for pointing out the problems I had with the modals when over the terminal.
